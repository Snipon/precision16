 ...
 */
function precision16_panels_default_style_render_region($display, $region_id, $panes, $settings) {
  $output = '';
 ...
 */
function precision16_preprocess_page(&$vars){
  ...
  if ($grid_overlay == 1) {
    ...
    $path = drupal_get_path('theme', 'precision16');
